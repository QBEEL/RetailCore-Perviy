...
def test_ставка_по_умолчанию_действующая_а_не_частая():
    """С 2026 года основная ставка — 22 %, и незаполненная ячейка означает её.

    В истории чаще встречается 20 %, но она осталась в прошлых оплатах: план
    заполняют на будущие месяцы.
    """
    assert vat.DEFAULT.percent == 22
    assert vat.DEFAULT is vat.of(22)
