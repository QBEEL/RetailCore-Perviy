...
# Ставка по умолчанию, когда её не указали: план заполняют на будущие месяцы, а
# с 2026 года основная ставка — 22 %. В истории чаще встречается 20 %, но она
# осталась в прошлых оплатах, и подставлять её в новые значило бы занижать НДС
# в каждой строке, где ячейку оставили пустой.
DEFAULT = RATES[1]
