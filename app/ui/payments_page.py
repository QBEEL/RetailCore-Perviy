...
class PaymentsPage(QWidget):
    ...
    def invalidate(self) -> None:
        ...
        Нужно, когда оплаты изменились не здесь — например, администратор стёр
        данные общей базы. Перечитывать сразу незачем: раздел в этот момент
        закрыт, а показывать результат некому.
        """
        self._loaded = False
